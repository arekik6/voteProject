	...
	if($_SESSION['role']){
      ...
      -->   
        ...
        <form name='frmSearch' action='' method='post'>
			 <div id="search" style="text-align:right;margin-left:20px;" ><input placeholder="Search for identifiers or names.." style="background:#FFF;left:50%;width: 30%;margin: 2px;" type='text' name='search[keyword]' value="<?= $search_keyword ?>" id='keyword' maxlength='25'></div> 
