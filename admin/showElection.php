...
if (isset($_SESSION['username']) && isset($_SESSION['password']) && isset($_SESSION['role'])) {
    if ($_SESSION['role']) {
        ...
        <link rel="stylesheet" href="../elections.css" crossorigin="anonymous">
        ...
        <div class="container">
                ...
                <ul>
                    ...
                    foreach ($candidates as $candidate) {
                        ...
                        <div class="form-check">
                            ...
                            <li style="font-size:1.5em;"><label><?= $candidate->firstName . ' ' . $candidate->lastName ?></label></li>
                        </div>
            ...
            <style src="../elections.css"></style>
            <table class='buttonsTable row-center11'>
